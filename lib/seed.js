  ...
  clients: [
    {
      ...
      profile: { industry: "Manufacturing", capabilities: ["Warehouse"], regulations: ["ISO 9001"], dependencies: { hasWarehouse: true, manufactures: true, operatesOwnTransport: false, sellsOnline: false } },
      contacts: [
    ...
    },
    {
      ...
      profile: { industry: "Manufacturing", capabilities: ["Field Service"], regulations: ["ISO 45001"], dependencies: { hasWarehouse: false, manufactures: true, operatesOwnTransport: false, sellsOnline: false } },
    ...
    },
    {
      ...
      profile: { industry: "Logistics", capabilities: ["Fleet Management", "Warehouse", "Exporting"], regulations: [], dependencies: { hasWarehouse: true, operatesOwnTransport: true, manufactures: false, sellsOnline: false } },
