  ...
  clients: [
    {
      ...
      profile: {
        industry: "Manufacturing", capabilities: ["Warehouse"], regulations: ["ISO 9001"],
        dependencies: { hasWarehouse: true, manufactures: true, operatesOwnTransport: false, sellsOnline: false },
        objectives: ["Reduce costs", "Improve operational efficiency", "Reduce business risk"],
        threeProblems: "Stock control is costing us money we can't account for, and I want to know if our current processes can support the growth we're planning.",
        hypothesis: { statement: "Unnecessary cost is being driven by poor stock control and warehouse inefficiency, not by capacity constraints.", targetConcepts: ["Stock Accuracy", "Warehouse Organisation"], formedDate: "2026-08-04" }
      },
      contacts: [
    ...
    {
      id: "c2", name: "ABC Engineering", industry: "Manufacturing", size: "11 to 50", turnover: "£4.1m",
      ...
      profile: { industry: "Manufacturing", capabilities: ["Field Service"], regulations: ["ISO 45001"], dependencies: { hasWarehouse: false, manufactures: true, operatesOwnTransport: false, sellsOnline: false }, objectives: ["Improve staff performance", "Prepare for growth"], threeProblems: "" },
    ...
    },
    {
      ...
      profile: { industry: "Logistics", capabilities: ["Fleet Management", "Warehouse", "Exporting"], regulations: [], dependencies: { hasWarehouse: true, operatesOwnTransport: true, manufactures: false, sellsOnline: false }, objectives: ["Prepare for growth", "Expand locations", "Improve operational efficiency"], threeProblems: "We're looking at opening a second site next year and want to know if our current operation could actually scale." },
